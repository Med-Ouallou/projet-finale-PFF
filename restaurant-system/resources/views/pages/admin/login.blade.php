...
<head>
    ...
    <title>Connexion - Resto Manager</title>
...
<body class="bg-gray-50 h-full flex flex-col items-center justify-center p-4 sm:p-6 font-sans antialiased">

    <!-- Minimal Header -->
    <header class="absolute top-0 w-full p-6 flex justify-between items-center">
        <a class="flex items-center gap-2.5 text-xl font-bold font-heading text-slate-900" href="{{ route('accueil') }}">
        ...
        <a class="inline-flex items-center gap-x-2 text-sm font-semibold text-gray-500 hover:text-emerald-600 transition-colors" href="{{ route('accueil') }}">
        ...
        <div class="bg-white border border-gray-100 rounded-3xl shadow-2xl shadow-slate-200 overflow-hidden">
            <div class="p-8 sm:p-10">
                <div class="text-center mb-8">
                    <h1 class="block text-2xl font-bold font-heading text-gray-900">Bienvenue</h1>
                    <p class="mt-2 text-sm text-gray-500">Connectez-vous pour accéder à votre espace de gestion.</p>
                </div>
                ...
                <form method="POST" action="{{ route('admin.login.post') }}">
                    ...
                    <div class="grid gap-y-5">
                        <!-- Email Field -->
                        <div>
                            <label for="email" class="block text-sm font-semibold mb-2 text-gray-800">Adresse Email</label>
                            <div class="relative">
                                <input type="email" id="email" name="email"
                                    class="py-3 px-4 ps-11 block w-full border border-gray-200 rounded-xl text-sm focus:border-emerald-500 focus:ring-emerald-500 disabled:opacity-50 disabled:pointer-events-none bg-gray-50"
                                    required placeholder="nom@exemple.com" value="{{ old('email') }}">
                        ...
                        <div>
                            <div class="flex justify-between items-center mb-2">
                                ...
                                <a class="text-sm text-emerald-600 decoration-2 hover:underline font-medium" href="#">Oublié ?</a>
                            </div>
                            <div class="relative">
            ...
            <div class="px-8 py-5 bg-gray-50 border-t border-gray-100 text-center">
                <p class="text-xs text-gray-400">&copy; {{ date('Y') }} RestoManager. Système de gestion sécurisé.</p>
            </div>
        </div>
    </main>
</body>
